    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2.5 group">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-violet-500 to-cyan-500 flex items-center justify-center shadow-lg shadow-violet-500/25 group-hover:shadow-violet-500/50 transition-shadow">
            <span className="text-white text-sm font-bold">✍</span>
          </div>
          <span className="font-semibold text-white/90 group-hover:text-white transition-colors">
            AutoWriter<span className="text-violet-400">.ai</span>
          </span>
        </Link>
